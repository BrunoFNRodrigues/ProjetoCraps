    ...
    if Pass_Line_Bet:
        ...
        if dados==7 or dados==11:
            ...
            if Point:
                ...
                dados=10
                i=0
                while dados!=ponto or dados!=7:
                    dados=10
                    i+=1
                if dados == 7:
                    print('Você perdeu o Point, agora você tem {0} fichas /n O dado foi rolado {1}'.format(ficha, i))
                    Point=False
                else:
                    ficha=ficha+aposta1*2
...
#Aposta Field
    if Field:
        if dados==5 or dados==6 or dados==7 or dados==8:
            ...
            Field=False
#Esse e o ultimi bloco do while de fichas
